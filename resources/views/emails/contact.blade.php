...
<body>
	<div class="container">
		...
		<p>Nous avons le plaisir de vous informer que votre objet a été prêté avec succès et que le paiement est en cours de traitement :</p>
	...
	<ul>
		<li>Client : {{ $data['clientname'] }} {{ $data['clientprenom'] }}</li>
