    ...
    <section class="mt-5 ">
        ...
        <section class="container">
            ...
            @csrf
                ...
                @endphp
<div class="row linge">
    <a href="{{route("userInfo" , ['id' => $partenaire->id])}}">
    <div class="col-12 col-md-4 a">
        
        <img src="{{asset($partenaire->profile)}}" class="profile" alt="">
        <p class="name">{{$partenaire->name}} {{$partenaire->prenom}}</p>
...
<hr>
            {{-- <picture>
                <img src="{{asset($partenaire->profile)}}" alt="" class="profile">
                <h3>{{$partenaire->name}} {{$partenaire->prenom}}</h3>
            </picture> --}}
